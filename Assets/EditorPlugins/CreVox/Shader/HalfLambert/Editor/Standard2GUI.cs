...
{
internal class Standard2GUI : ShaderGUI
{
	...
	private static class Styles
	{
        ...
        public static GUIContent wrapAmountText = new GUIContent("Wrap Amount", "Wrap Amount");
	...
	MaterialProperty bumpMap = null;
        MaterialProperty wrapAmount = null;
	...
	public void FindProperties (MaterialProperty[] props)
	{
		...
		bumpScale = FindProperty ("_BumpScale", props);
            wrapAmount = FindProperty ("_WrapAmount", props);
	...
	public void ShaderPropertiesGUI (Material material)
	{
		...
		EditorGUI.BeginChangeCheck();
		{
			...
			m_MaterialEditor.TexturePropertySingleLine(Styles.normalMapText, bumpMap, bumpMap.textureValue != null ? bumpScale : null);
                m_MaterialEditor.ShaderProperty (wrapAmount, Styles.wrapAmountText);
