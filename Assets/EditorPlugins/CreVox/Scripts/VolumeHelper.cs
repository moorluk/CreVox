...
namespace CreVox
{
    ...
    {
        public static void Mirror (Volume a_v, WorldPos a_position, WorldPos a_rotation, WorldPos a_scale, LevelPiece a_p, bool a_mappingX, bool a_mappingZ)
        {
        ...
        public static void MirrorPosition (Volume a_v, WorldPos a_position, WorldPos a_scale, bool a_erase, bool a_mappingX, bool a_mappingZ)
        {
            WorldPos mPos = a_position;
            if (mPos.x == a_position.x && mPos.z == a_position.z) {
